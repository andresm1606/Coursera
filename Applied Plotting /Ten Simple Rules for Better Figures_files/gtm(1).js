...
"resource": {
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "unlimited":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Evar styles=\"\\x3cstyle\\x3ediv.survey{padding:3em;background-color:#fb8903;margin-bottom:1em;color:#efefef}div.survey h1{font-size:3rem;margin-bottom:1rem;margin-top:0}div.survey p{margin:0}\\x3c\/style\\x3e\";document.head.insertAdjacentHTML(\"beforeend\",styles);var newDiv=document.createElement(\"div\");newDiv.setAttribute(\"class\",\"survey\");var heading=document.createElement(\"h1\");heading.innerHTML=\"We Value Your Feedback\";newDiv.appendChild(heading);var paragraph=document.createElement(\"p\");\nparagraph.innerHTML='Help PLOS determine the future of this product! Please take a moment to complete a \\x3ca href\\x3d\"https:\/\/forms.gle\/41uLPZsnWZ8CsLBD9\"\\x3ebrief survey\\x3c\/a\\x3e to help determine the future direction of ALM Reports. Your participation helps PLOS make better products.';newDiv.appendChild(paragraph);var container=document.querySelector(\".section.main\");container.prepend(newDiv);\u003C\/script\u003E",
...
return null},Ad=!1;if(H.querySelectorAll)try{var Bd=H.querySelectorAll(":root");Bd&&1==Bd.length&&Bd[0]==H.documentElement&&(Ad=!0)}catch(a){}var vd=Ad;var Pd={},L=null,Qd=Math.random();Pd.B="GTM-TP26BH";Pd.Sb="920";Pd.Mh="";var Rd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Sd="www.googletagmanager.com/gtm.js";
var Td=Sd,Ud=null,Vd=null,Wd="//www.googletagmanager.com/a?id="+Pd.B+"&cv=52",Xd={},Yd={},Zd=function(){var a=L.sequence||1;L.sequence=a+1;return a};
...
Z.a.c=["google"],function(){(function(a){Z.__c=a;Z.__c.b="c";Z.__c.g=!0;Z.__c.priorityOverride=0})(function(a){Sl(a.vtp_value,"c",a.vtp_gtmEventId);return a.vtp_value})}();
...
Z.a.aev=["google"],function(){function a(q,u){var v=Ie(q,"gtm");if(v)return v[u]}function b(q,u,v,w){w||(w="element");var z=q+"."+u,x;if(n.hasOwnProperty(z))x=n[z];else{var A=a(q,w);if(A&&(x=v(A),n[z]=x,r.push(z),35<r.length)){var B=r.shift();delete n[B]}}return x}function c(q,u,v){var w=a(q,t[u]);return void 0!==w?w:v}function d(q,u){if(!q)return!1;var v=e(Fl());xa(u)||(u=String(u||"").replace(/\s+/g,"").split(","));for(var w=[v],z=0;z<u.length;z++)if(u[z]instanceof RegExp){if(u[z].test(q))return!1}else{var x=
u[z];if(0!=x.length){if(0<=e(q).indexOf(x))return!1;w.push(e(x))}}return!xm(q,w)}function e(q){p.test(q)||(q="http://"+q);return Qe(Se(q),"HOST",!0)}function f(q,u,v){switch(q){case "SUBMIT_TEXT":return b(u,"FORM."+q,h,"formSubmitElement")||v;case "LENGTH":var w=b(u,"FORM."+q,k);return void 0===w?v:w;case "INTERACTED_FIELD_ID":return l(u,"id",v);case "INTERACTED_FIELD_NAME":return l(u,"name",v);case "INTERACTED_FIELD_TYPE":return l(u,"type",v);case "INTERACTED_FIELD_POSITION":var z=a(u,"interactedFormFieldPosition");
return void 0===z?v:z;case "INTERACT_SEQUENCE_NUMBER":var x=a(u,"interactSequenceNumber");return void 0===x?v:x;default:return v}}function h(q){switch(q.tagName.toLowerCase()){case "input":return Vc(q,"value");case "button":return Wc(q);default:return null}}function k(q){if("form"===q.tagName.toLowerCase()&&q.elements){for(var u=0,v=0;v<q.elements.length;v++)cl(q.elements[v])&&u++;return u}}function l(q,u,v){var w=a(q,"interactedFormField");return w&&Vc(w,u)||v}var p=/^https?:\/\//i,n={},r=[],t={ATTRIBUTE:"elementAttribute",
...
v;case "TEXT":return b(u,w,Wc)||v;case "URL":var x;a:{var A=String(a(u,"elementUrl")||v||""),B=Se(A),y=String(q.vtp_component||"URL");switch(y){case "URL":x=A;break a;case "IS_OUTBOUND":x=d(A,q.vtp_affiliatedDomains);break a;default:x=Qe(B,y,q.vtp_stripWww,q.vtp_defaultPages,q.vtp_queryKey)}}return x;case "ATTRIBUTE":var C;if(void 0===q.vtp_attribute)C=c(u,w,v);else{var G=q.vtp_attribute,J=a(u,"element");C=J&&Vc(J,G)||v||""}return C;case "MD":var P=q.vtp_mdValue,T=b(u,"MD",ol);return P&&T?rl(T,P)||
v:T||v;case "FORM":return f(String(q.vtp_component||"SUBMIT_TEXT"),u,v);default:var V=c(u,w,v);Sl(V,"aev",q.vtp_gtmEventId);return V}})}();
...
Z.a.lcl=[],function(){function a(){var c=X("document"),d=0,e=function(f){var h=f.target;if(h&&3!==f.which&&!(f.Rg||f.timeStamp&&f.timeStamp===d)){d=f.timeStamp;h=Yc(h,["a","area"],100);if(!h)return f.returnValue;var k=f.defaultPrevented||!1===f.returnValue,l=$k("lcl",k?"nv.mwt":"mwt",0),p;p=k?$k("lcl","nv.ids",[]):$k("lcl","ids",[]);if(p.length){var n=Wk(h,"gtm.linkClick",p);if(b(f,h,c)&&!k&&l&&h.href){var r=String(Rl(h,"rel")||""),t=!!za(r.split(" "),function(v){return"noreferrer"===v.toLowerCase()});
t&&E(36);var q=X((Rl(h,"target")||"_self").substring(1)),u=!0;if(Jl(n,Mk(function(){var v;if(v=u&&q){var w;a:if(t){var z;try{z=new MouseEvent(f.type)}catch(x){if(!c.createEvent){w=!1;break a}z=c.createEvent("MouseEvents");z.initEvent(f.type,!0,!0)}z.Rg=!0;f.target.dispatchEvent(z);w=!0}else w=!1;v=!w}v&&(q.location.href=Rl(h,"href"))}),l))u=!1;else return f.preventDefault&&f.preventDefault(),f.returnValue=!1}else Jl(n,function(){},l||2E3);return!0}}};Tc(c,"click",e,!1);Tc(c,"auxclick",e,!1)}function b(c,
d,e){if(2===c.which||c.ctrlKey||c.shiftKey||c.altKey||c.metaKey)return!1;var f=Rl(d,"href"),h=f.indexOf("#"),k=Rl(d,"target");if(k&&"_self"!==k&&"_parent"!==k&&"_top"!==k||0===h)return!1;if(0<h){var l=Hl(f),p=Hl(e.location);return l!==p}return!0}(function(c){Z.__lcl=c;Z.__lcl.b="lcl";Z.__lcl.g=!0;Z.__lcl.priorityOverride=0})(function(c){var d=void 0===c.vtp_waitForTags?!0:c.vtp_waitForTags,e=void 0===c.vtp_checkValidation?!0:c.vtp_checkValidation,f=Number(c.vtp_waitForTagsTimeout);if(!f||0>=f)f=2E3;
var h=c.vtp_uniqueTriggerId||"0";if(d){var k=function(p){return Math.max(f,p)};Zk("lcl","mwt",k,0);e||Zk("lcl","nv.mwt",k,0)}var l=function(p){p.push(h);return p};Zk("lcl","ids",l,[]);e||Zk("lcl","nv.ids",l,[]);Ol("lcl")||(a(),Pl("lcl"));I(c.vtp_gtmOnSuccess)})}();
